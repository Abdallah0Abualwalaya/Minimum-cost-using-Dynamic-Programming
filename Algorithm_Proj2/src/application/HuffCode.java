...
public class HuffCode implements Comparable<HuffCode> {
	...
	public HuffCode(char character) {this.character = character;}
	...
	public void sethuffCode(String huffCode) {this.huffCode = huffCode;}
	...
	public String getHuffCode() {return huffCode;}

	public int getCodeLength() {return codeLength;}

	@Override
	public int compareTo(HuffCode t) {return huffCode.compareTo(t.huffCode);}
