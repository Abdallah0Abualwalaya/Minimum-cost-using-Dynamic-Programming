...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws FileNotFoundException {
		...
		findMinCost.setStyle("-fx-background-color: white; -fx-border-color: blue; -fx-border-radius: 5; -fx-background-radius: 20em;");
		...
		printPath.setStyle("-fx-background-color: white; -fx-border-color: blue; -fx-border-radius: 5; -fx-background-radius: 20em;");
		...
		btTable.setStyle("-fx-background-color: white; -fx-border-color: blue; -fx-border-radius: 5; -fx-background-radius: 20em;");
		btTable.setTextFill(Color.BLUE);
		...
		printOthers.setStyle("-fx-background-color: white; -fx-border-color: blue; -fx-border-radius: 5; -fx-background-radius: 20em;");
		...
		VBox vBox = new VBox();
		vBox.getChildren().addAll(hbChooser, best, hbTable, hbAlternative, btTable);
		vBox.setSpacing(30);
	...
	//======================================= Second Scene ================================================================
		...
		showTable.setStyle("-fx-background-color: white; -fx-border-color: red; -fx-border-radius: 5;");
		...
		back.setFont(font);
		back.setStyle("-fx-background-color: white; -fx-border-color: red; -fx-border-radius: 5;");
		back.setTextFill(Color.BLUE);

		VBox vbTable = new VBox(hbTableCost,taTable, back);
		vbTable.setSpacing(50);
		vbTable.setBackground(new Background(new BackgroundFill(Color.GREY, CornerRadii.EMPTY, Insets.EMPTY)));
